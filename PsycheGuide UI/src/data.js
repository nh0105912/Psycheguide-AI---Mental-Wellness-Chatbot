...
import anixty2 from "./assets/anxity1.jpg";
...
export const resourcesData = [
  {
    ...
    img: `${anixty1}`,
    description:
      "Learn practical techniques to recognize anxiety triggers and develop healthy coping mechanisms for daily life.",
    readTime: "8 min read",
    category: "Anxiety",
    link: "/resources/anxiety",
    fullText: `
Anxiety is a natural emotional response to stress — but when it becomes overwhelming, it can affect daily life.
Learning to understand your triggers and recognizing early signs can help reduce anxiety before it takes control.

Identifying Triggers:
Notice patterns — does anxiety arise before social events, exams, travel, or unexpected changes?
Recognizing these helps you prepare and respond with awareness.
...
• 2 you can smell
• 1 you can taste
This shifts your focus back to the present moment.

Building Healthy Coping Practices:
Daily habits such as journaling, mindful breaks, and regular exercise lower baseline anxiety levels.
Small steps matter — consistency is more important than intensity.

Remember:
Anxiety does not define you. It's a part of your experience, not your identity.
Learning to work *with* your emotions builds resilience and inner strength.
`,
  },
  {
    id: 2,
    title: "Breathing Practices to Reduce Panic",
    img: `${anixty2}`,
    description:
      "Quick breathing exercises to calm your body when anxiety peaks.",
    readTime: "6 min read",
    category: "Anxiety",
    link: "/resources/anxiety/breathing",
    fullText: `
When panic rises, your breath becomes fast and shallow — signaling danger to your body.
By slowing your breath, you tell your nervous system that you are safe.
...
• Exhale for 4
• Hold for 4
Repeat 4 rounds. Notice the slowing of your heartbeat.

Extended Exhale:
• Inhale for 4 seconds, exhale for 6
This activates the parasympathetic nervous system — your body's calming system.

Affirmation While Breathing:
"I am safe in this moment."
"These feelings will pass."
"I can breathe through this."

With practice, breathing becomes your inner anchor during emotional storms.
`,
  },
